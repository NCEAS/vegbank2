...
INSERT INTO temptbl_std_plantnames (
        plantConcept_ID,
        sciname,
        scinamenoauth,
        code,
...
SELECT plantConcept_ID,
    (
        select (plantname)
        from view_std_plantnames_sciname as newnames
        WHERE newnames.plantconcept_ID = plantconcept.plantconcept_id
        limit 1
    ), (
        select (plantname)
        from view_std_plantnames_scinamenoauth as newnames
        WHERE newnames.plantconcept_ID = plantconcept.plantconcept_id
        limit 1
    ), (
        select (plantname)
        from view_std_plantnames_code as newnames
        WHERE newnames.plantconcept_ID = plantconcept.plantconcept_id
        limit 1
    ), (
        select (plantname)
        from view_std_plantnames_common as newnames
        WHERE newnames.plantconcept_ID = plantconcept.plantconcept_id
        limit 1
    ), plantname
FROM plantConcept;
...
UPDATE temptbl_std_plantnames
SET sciname =(
        select min(plantname)
        from view_all_plantnames_sciname as newnames
        WHERE newnames.plantconcept_ID = temptbl_std_plantnames.plantconcept_id
    )
...
SET scinamenoauth =(
        select min(plantname)
        from view_all_plantnames_scinamenoauth as newnames
        WHERE newnames.plantconcept_ID = temptbl_std_plantnames.plantconcept_id
    )
WHERE scinamenoauth is null;
...
SET common =(
        select min(plantname)
        from view_all_plantnames_common as newnames
        WHERE newnames.plantconcept_ID = temptbl_std_plantnames.plantconcept_id
    )
...
SELECT commConcept_ID,
    (
        select (commname)
        from view_std_commnames_sciname as newnames
        WHERE newnames.commconcept_ID = commconcept.commconcept_id
        limit 1
    ), (
        select (commname)
        from view_std_commnames_translated as newnames
        WHERE newnames.commconcept_ID = commconcept.commconcept_id
        limit 1
    ), (
        select (commname)
        from view_std_commnames_code as newnames
        WHERE newnames.commconcept_ID = commconcept.commconcept_id
        limit 1
    ), (
        select (commname)
        from view_std_commnames_common as newnames
        WHERE newnames.commconcept_ID = commconcept.commconcept_id
        limit 1
    )
FROM commConcept;
...
--    WHERE newnames.commconcept_ID = commconcept.commconcept_id);
--get any that aren't std:
UPDATE temptbl_std_commnames
SET sciname =(
        select min(commname)
        from view_all_commnames_sciname as newnames
        WHERE newnames.commconcept_ID = temptbl_std_commnames.commconcept_id
    )
WHERE sciname is null;
UPDATE temptbl_std_commnames
SET translated =(
        select min(commname)
        from view_all_commnames_translated as newnames
        WHERE newnames.commconcept_ID = temptbl_std_commnames.commconcept_id
    )
...
SET code =(
        select min(commname)
        from view_all_commnames_code as newnames
        WHERE newnames.commconcept_ID = temptbl_std_commnames.commconcept_id
    )
WHERE code is null;
UPDATE temptbl_std_commnames
SET common =(
        select min(commname)
        from view_all_commnames_common as newnames
        WHERE newnames.commconcept_ID = temptbl_std_commnames.commconcept_id
    )
WHERE common is null;