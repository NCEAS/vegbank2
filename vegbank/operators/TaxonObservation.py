...
class TaxonObservation(Operator):
    ...
    def upload_stem_data(self, df, conn):
        ...
        stem_count_def_for_validation.append('vb_tm_code') #This will be generated by the taxon importance upload upstream, so we don't want users providing it. 
        ...
        stem_location_def_for_validation.append('vb_sc_code') #This will be generated by the stem count upload above, so we don't want users providing it. 
